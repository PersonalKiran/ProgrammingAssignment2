# This function creates or takes a given matrix and provides set/get methods on the "mat" object.
...
#This function is a helper function which takes a matrix object and creates an 
#inverse of it if it is not already created. It calls the solve method to create
#inverse of a matrix only if it is not already created. If this function is called
#more than once, then inverse of the matrix that is cached during the first call is 
